...
const SummaryCard = ({
  ...
  return (
    <div
      className="bg-white border border-gray-300/40 rounded-xl p-2 overflow-visible cursor-pointer hover:shadow-xl shadow-gray-100 relative group"
      onClick={onSelect}
    >
      {/* Top section */}
      <div
      ...
      >
        ...
        {/* Delete Button */}
        <button
          className="opacity-0 group-hover:opacity-100 items-center gap-2 text-xs text-rose-500 font-medium bg-rose-50 px-3 py-1 rounded border border-rose-100 hover:border-rose-200 cursor-pointer absolute top-2 right-2 transition-opacity duration-300 z-10"
          onClick={(e) => {
            e.stopPropagation();
            onDelete();
          }}
