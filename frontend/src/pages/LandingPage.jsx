    ...
    <div className="w-full min-h-full bg-[#FFFCEF] ">
      ...
      <div className="container mx-auto px-4 pt-6 pb-[200px] relative z-10">
        ...
        <header className="flex justify-between items-center mb-16">
          ...
          <button
            className="bg-linear-to-r from-[#FF9324] to-[#e99a4b] text-sm font-semibold px-4 py-2 rounded-full hover:bg-black hover:text-white border border-white transition-colors cursor-pointer"
...
{/* Remaining 2 cards */}
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    {APP_FEATURES.slice(3).map((feature) => (
      <div key={feature.id} className="bg-[#FFFFF8] p-6 rounded-xl shadow-xs hover:shadow-lg shadow-amber-100 transition border border-amber-100">
        <h3 className="text-base font-semibold mb-3">{feature.title}</h3>
        <p className="text-gray-600">{feature.description}</p>
      </div>
    ))}
